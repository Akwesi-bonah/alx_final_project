...
$("#quickPayBtn").on("click", function () {
  ...
  let booking_id = $(this).data("book-id");
  let paymentReference = "PAYREF_" + Math.floor(Math.random() * 1000000000 + 1);
  ...
  $.ajax({
    ...
    success: function (response) {
      let paymentDetails = response.booking_info;
                ...
                custom_fields: [
                  {
                    ...
                    letiable_name: paymentDetails.room_name,
